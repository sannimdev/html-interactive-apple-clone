...
(() => {
    ...
    const sceneInfo = [
        ...
        },
        {
            ...
            objs: {
                ...
                imagesPath: [
                    './examples/apple-clone-v10/images/blend-image-1.jpg',
                    './examples/apple-clone-v10/images/blend-image-2.jpg',
                ],
                images: [],
            },
            values: {
    ...
    function setCanvasImages() {
        ...
        for (let i = 0; i < sceneInfo[0].values.videoImageCount; i++) {
            imgElem = new Image();
            imgElem.src = `./examples/apple-clone-v10/video/001/IMG_${6726 + i}.JPG`;
        ...
        for (let i = 0; i < sceneInfo[2].values.videoImageCount; i++) {
            imgElem2 = new Image();
            imgElem2.src = `./examples/apple-clone-v10/video/002/IMG_${7027 + i}.JPG`;
    ...
    function playAnimation() {
        ...
        switch (currentScene) {
            ...
            case 2:
                ...
                // currentScene 3 에서 쓰는 캔버스 미리 그려주기
                if (scrollRatio > 0.9) {
            ...
            case 3:
                ...
                if (!values.rectStartY) {
                    ...
                    const rectStart = window.innerHeight / 2 / scrollHeight;
                    const rectEnd = values.rectStartY / scrollHeight;
                    values.rect1X[2].start = values.rect2X[2].start = rectStart;
                    values.rect1X[2].end = values.rect2X[2].end = rectEnd;
                }
    ...
    function scrollLoop() {
        if (currentScene > 3) return; // 일단 버그 임시로 해결하기
        enterNewScene = false;
        prevScrollHeight = 0;
